...
// 이 파일은 tools/generate-sf-symbol-names.py 가 만든다. 직접 고치지 말 것.
// iOS 26.0 까지 쓸 수 있는 심볼 6422개.

/// 줄바꿈으로 이어붙인 SF Symbol 이름. 배열 리터럴은 컴파일이 느려서
/// 문자열 하나로 두고 `SFSymbolCatalog` 가 처음 쓸 때 쪼갠다.
let sfSymbolNameList = """
square.and.arrow.up
